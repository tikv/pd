...
// SplitKeyspaceGroupByID splits the keyspace group by ID.
func (m *GroupManager) SplitKeyspaceGroupByID(id, newID uint32) error {
	...
	return m.saveKeyspaceGroups([]*endpoint.KeyspaceGroup{newKg})
}
