...
// SplitKeyspaceGroupByID splits the keyspace group by ID into a new keyspace group with the new ID
// and the keyspaces will be assigned to the new keyspace group.
