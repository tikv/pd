...
func TestPatchResourceGroup(t *testing.T) {
	...
	testCaseRU := []struct {
		...
		{`{"name":"test", "mode":1, "r_u_settings": {"r_u":{"settings":{"fill_rate": 200000}}}}`,
			`{"name":"test","mode":1,"r_u_settings":{"ru":{"settings":{"fill_rate":200000,"max_tokens":10000000},"state":{"initialized":false}}}}`},
		{`{"name":"test", "mode":1, "r_u_settings": {"r_u":{"settings":{"fill_rate": 200000, "burst": -1}}}}`,
			`{"name":"test","mode":1,"r_u_settings":{"ru":{"settings":{"fill_rate":200000,"max_tokens":10000000},"state":{"initialized":false}}}}`},
	}
	...
	testCaseResource := []struct {
		...
		{`{"name":"test", "mode":2, "raw_resource_settings": {"cpu":{"settings":{"fill_rate": 200000}}}}`,
			`{"name":"test","mode":2,"raw_resource_settings":{"cpu":{"settings":{"fill_rate":200000,"max_tokens":10000000},"state":{"initialized":false}},"io_read_bandwidth":{"state":{"initialized":false}},"io_write_bandwidth":{"state":{"initialized":false}}}}`},
		{`{"name":"test", "mode":2, "raw_resource_settings": {"io_read":{"settings":{"fill_rate": 200000}}}}`,
			`{"name":"test","mode":2,"raw_resource_settings":{"cpu":{"state":{"initialized":false}},"io_read_bandwidth":{"settings":{"fill_rate":200000,"max_tokens":10000000},"state":{"initialized":false}},"io_write_bandwidth":{"state":{"initialized":false}}}}`},
		{`{"name":"test", "mode":2, "raw_resource_settings": {"io_write":{"settings":{"fill_rate": 200000}}}}`,
			`{"name":"test","mode":2,"raw_resource_settings":{"cpu":{"state":{"initialized":false}},"io_read_bandwidth":{"state":{"initialized":false}},"io_write_bandwidth":{"settings":{"fill_rate":200000,"max_tokens":10000000},"state":{"initialized":false}}}}`},
	}
