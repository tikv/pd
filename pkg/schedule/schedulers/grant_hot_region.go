...
func (s *grantHotRegionScheduler) IsScheduleAllowed(cluster scheduling.ClusterInformer) bool {
...
func (s *grantHotRegionScheduler) Schedule(cluster scheduling.ClusterInformer, dryRun bool) ([]*operator.Operator, []plan.Plan) {
...
func (s *grantHotRegionScheduler) dispatch(typ statistics.RWType, cluster scheduling.ClusterInformer) []*operator.Operator {
...
func (s *grantHotRegionScheduler) randomSchedule(cluster scheduling.ClusterInformer, srcStores []*statistics.StoreLoadDetail) (ops []*operator.Operator) {
...
func (s *grantHotRegionScheduler) transfer(cluster scheduling.ClusterInformer, regionID uint64, srcStoreID uint64, isLeader bool) (op *operator.Operator, err error) {
