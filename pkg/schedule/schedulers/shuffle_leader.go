...
func (s *shuffleLeaderScheduler) IsScheduleAllowed(cluster scheduling.ClusterInformer) bool {
...
func (s *shuffleLeaderScheduler) Schedule(cluster scheduling.ClusterInformer, dryRun bool) ([]*operator.Operator, []plan.Plan) {
