...
var (
	...
	evictLeaderPickReadHotCounter          = evictLeaderCounterWithEvent("pick-read-hot-region")
	evictLeaderPickWriteHotCounter         = evictLeaderCounterWithEvent("pick-write-hot-region")
	evictLeaderHotCandidateRejectedCounter = evictLeaderCounterWithEvent("hot-candidate-rejected")
	evictLeaderHotFallbackCounter          = evictLeaderCounterWithEvent("hot-candidate-fallback")
