...
type RegionReplicatedFilter struct {
	cluster scheduling.RegionHealthCluster
	fit     *placement.RegionFit
}

// NewRegionReplicatedFilter creates a RegionFilter that filters all unreplicated regions.
func NewRegionReplicatedFilter(cluster scheduling.RegionHealthCluster) RegionFilter {
...
func NewRegionEmptyFilter(cluster scheduling.RegionHealthCluster) RegionFilter {
...
func isEmptyRegionAllowBalance(cluster scheduling.RegionHealthCluster, region *core.RegionInfo) bool {
