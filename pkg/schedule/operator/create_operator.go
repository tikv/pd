...
func CreateAddPeerOperator(desc string, ci scheduling.ClusterInformer, region *core.RegionInfo, peer *metapb.Peer, kind OpKind) (*Operator, error) {
...
func CreateDemoteVoterOperator(desc string, ci scheduling.ClusterInformer, region *core.RegionInfo, peer *metapb.Peer) (*Operator, error) {
	return NewBuilder(desc, ci, region).
...
func CreatePromoteLearnerOperator(desc string, ci scheduling.ClusterInformer, region *core.RegionInfo, peer *metapb.Peer) (*Operator, error) {
	return NewBuilder(desc, ci, region).
...
func CreateRemovePeerOperator(desc string, ci scheduling.ClusterInformer, kind OpKind, region *core.RegionInfo, storeID uint64) (*Operator, error) {
	return NewBuilder(desc, ci, region).
		RemovePeer(storeID).
		Build(kind)
}
...
func CreateTransferLeaderOperator(desc string, ci scheduling.ClusterInformer, region *core.RegionInfo, sourceStoreID uint64, targetStoreID uint64, targetStoreIDs []uint64, kind OpKind) (*Operator, error) {
...
func CreateForceTransferLeaderOperator(desc string, ci scheduling.ClusterInformer, region *core.RegionInfo, sourceStoreID uint64, targetStoreID uint64, kind OpKind) (*Operator, error) {
...
func CreateMoveRegionOperator(desc string, ci scheduling.ClusterInformer, region *core.RegionInfo, kind OpKind, roles map[uint64]placement.PeerRoleType) (*Operator, error) {
...
func CreateMovePeerOperator(desc string, ci scheduling.ClusterInformer, region *core.RegionInfo, kind OpKind, oldStore uint64, peer *metapb.Peer) (*Operator, error) {
	return NewBuilder(desc, ci, region).
		RemovePeer(oldStore).
		AddPeer(peer).
		Build(kind)
...
func CreateMoveWitnessOperator(desc string, ci scheduling.ClusterInformer, region *core.RegionInfo, sourceStoreID uint64, targetStoreID uint64) (*Operator, error) {
	return NewBuilder(desc, ci, region).
...
func CreateReplaceLeaderPeerOperator(desc string, ci scheduling.ClusterInformer, region *core.RegionInfo, kind OpKind, oldStore uint64, peer *metapb.Peer, leader *metapb.Peer) (*Operator, error) {
	return NewBuilder(desc, ci, region).
		RemovePeer(oldStore).
		AddPeer(peer).
...
func CreateMoveLeaderOperator(desc string, ci scheduling.ClusterInformer, region *core.RegionInfo, kind OpKind, oldStore uint64, peer *metapb.Peer) (*Operator, error) {
	return NewBuilder(desc, ci, region).
		RemovePeer(oldStore).
		AddPeer(peer).
...
func CreateMergeRegionOperator(desc string, ci scheduling.ClusterInformer, source *core.RegionInfo, target *core.RegionInfo, kind OpKind) ([]*Operator, error) {
...
func CreateScatterRegionOperator(desc string, ci scheduling.ClusterInformer, origin *core.RegionInfo, targetPeers map[uint64]*metapb.Peer, targetLeader uint64) (*Operator, error) {
...
func CreateLeaveJointStateOperator(desc string, ci scheduling.ClusterInformer, origin *core.RegionInfo) (*Operator, error) {
...
func CreateWitnessPeerOperator(desc string, ci scheduling.ClusterInformer, region *core.RegionInfo, peer *metapb.Peer) (*Operator, error) {
	return NewBuilder(desc, ci, region).
...
func CreateNonWitnessPeerOperator(desc string, ci scheduling.ClusterInformer, region *core.RegionInfo, peer *metapb.Peer) (*Operator, error) {
	return NewBuilder(desc, ci, region).
