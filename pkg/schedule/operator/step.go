...
type OpStep interface {
	...
	CheckInProgress(ci scheduling.ClusterInformer, region *core.RegionInfo) error
...
func (tl TransferLeader) CheckInProgress(ci scheduling.ClusterInformer, region *core.RegionInfo) error {
...
// CheckInProgress checks if the step is in the progress of advancing.
func (ap AddPeer) CheckInProgress(ci scheduling.ClusterInformer, region *core.RegionInfo) error {
...
// CheckInProgress checks if the step is in the progress of advancing.
func (bw BecomeWitness) CheckInProgress(ci scheduling.ClusterInformer, region *core.RegionInfo) error {
...
// CheckInProgress checks if the step is in the progress of advancing.
func (bn BecomeNonWitness) CheckInProgress(ci scheduling.ClusterInformer, region *core.RegionInfo) error {
...
// CheckInProgress checks if the step is in the progress of advancing.
func (bsw BatchSwitchWitness) CheckInProgress(ci scheduling.ClusterInformer, region *core.RegionInfo) error {
	for _, w := range bsw.ToWitnesses {
...
// CheckInProgress checks if the step is in the progress of advancing.
func (al AddLearner) CheckInProgress(ci scheduling.ClusterInformer, region *core.RegionInfo) error {
...
// CheckInProgress checks if the step is in the progress of advancing.
func (pl PromoteLearner) CheckInProgress(_ scheduling.ClusterInformer, region *core.RegionInfo) error {
...
// CheckInProgress checks if the step is in the progress of advancing.
func (rp RemovePeer) CheckInProgress(_ scheduling.ClusterInformer, region *core.RegionInfo) error {
...
// CheckInProgress checks if the step is in the progress of advancing.
func (mr MergeRegion) CheckInProgress(_ scheduling.ClusterInformer, _ *core.RegionInfo) error {
	return nil
}
...
// CheckInProgress checks if the step is in the progress of advancing.
func (sr SplitRegion) CheckInProgress(_ scheduling.ClusterInformer, _ *core.RegionInfo) error {
	return nil
}
...
// CheckInProgress checks if the step is in the progress of advancing.
func (cpe ChangePeerV2Enter) CheckInProgress(_ scheduling.ClusterInformer, region *core.RegionInfo) error {
...
// CheckInProgress checks if the step is in the progress of advancing.
func (cpl ChangePeerV2Leave) CheckInProgress(_ scheduling.ClusterInformer, region *core.RegionInfo) error {
...
func validateStore(ci scheduling.ClusterInformer, id uint64) error {
