...
// BecomeNonWitness is an OpStep that converts a legacy witness peer to a
// regular peer. It is retained only for rolling-upgrade compatibility.
...
func (bn BecomeNonWitness) GetCmd(*core.RegionInfo, bool) *hbstream.Operation {
	return &hbstream.Operation{
		SwitchWitnesses: &pdpb.BatchSwitchWitness{
			SwitchWitnesses: []*pdpb.SwitchWitness{{PeerId: bn.PeerID, IsWitness: false}},
		},
	}
}
