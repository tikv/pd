...
var (
	...
	ruleCheckerCounter                            = counterWithEvent(config.RuleChecker, "check")
	ruleCheckerPausedCounter                      = counterWithEvent(config.RuleChecker, "paused")
	ruleCheckerRegionNoLeaderCounter              = counterWithEvent(config.RuleChecker, "region-no-leader")
	ruleCheckerGetCacheCounter                    = counterWithEvent(config.RuleChecker, "get-cache")
	ruleCheckerNeedSplitCounter                   = counterWithEvent(config.RuleChecker, "need-split")
	ruleCheckerSetCacheCounter                    = counterWithEvent(config.RuleChecker, "set-cache")
	ruleCheckerReplaceDownCounter                 = counterWithEvent(config.RuleChecker, "replace-down")
	ruleCheckerPromoteWitnessCounter              = counterWithEvent(config.RuleChecker, "promote-witness")
	ruleCheckerReplaceOfflineCounter              = counterWithEvent(config.RuleChecker, "replace-offline")
	ruleCheckerAddRulePeerCounter                 = counterWithEvent(config.RuleChecker, "add-rule-peer")
	ruleCheckerNoStoreAddCounter                  = counterWithEvent(config.RuleChecker, "no-store-add")
	ruleCheckerNoStoreThenTryReplace              = counterWithEvent(config.RuleChecker, "no-store-then-try-replace")
	ruleCheckerNoStoreReplaceCounter              = counterWithEvent(config.RuleChecker, "no-store-replace")
	ruleCheckerFixPeerRoleCounter                 = counterWithEvent(config.RuleChecker, "fix-peer-role")
	ruleCheckerFixLeaderRoleCounter               = counterWithEvent(config.RuleChecker, "fix-leader-role")
	ruleCheckerNotAllowLeaderCounter              = counterWithEvent(config.RuleChecker, "not-allow-leader")
	ruleCheckerFixFollowerRoleCounter             = counterWithEvent(config.RuleChecker, "fix-follower-role")
	ruleCheckerNoNewLeaderCounter                 = counterWithEvent(config.RuleChecker, "no-new-leader")
	ruleCheckerDemoteVoterRoleCounter             = counterWithEvent(config.RuleChecker, "demote-voter-role")
	ruleCheckerRecentlyPromoteToNonWitnessCounter = counterWithEvent(config.RuleChecker, "recently-promote-to-non-witness")
	ruleCheckerCancelSwitchToWitnessCounter       = counterWithEvent(config.RuleChecker, "cancel-switch-to-witness")
	ruleCheckerSetVoterWitnessCounter             = counterWithEvent(config.RuleChecker, "set-voter-witness")
	ruleCheckerSetLearnerWitnessCounter           = counterWithEvent(config.RuleChecker, "set-learner-witness")
	ruleCheckerSetVoterNonWitnessCounter          = counterWithEvent(config.RuleChecker, "set-voter-non-witness")
	ruleCheckerSetLearnerNonWitnessCounter        = counterWithEvent(config.RuleChecker, "set-learner-non-witness")
	ruleCheckerMoveToBetterLocationCounter        = counterWithEvent(config.RuleChecker, "move-to-better-location")
	ruleCheckerSkipRemoveOrphanPeerCounter        = counterWithEvent(config.RuleChecker, "skip-remove-orphan-peer")
	ruleCheckerRemoveOrphanPeerCounter            = counterWithEvent(config.RuleChecker, "remove-orphan-peer")
	ruleCheckerReplaceOrphanPeerCounter           = counterWithEvent(config.RuleChecker, "replace-orphan-peer")
	ruleCheckerReplaceOrphanPeerNoFitCounter      = counterWithEvent(config.RuleChecker, "replace-orphan-peer-no-fit")
)
