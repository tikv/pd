...
var (
	...
	InternalOperatorStepUnknown = ClassInternal.DefineError().TextualCode("InternalOperatorNotFound").MessageTemplate("operator step is unknown").Done()
	InternalStoreNotFound = ClassInternal.DefineError().TextualCode("InternalStoreNotFound").MessageTemplate("store not found").Done()
