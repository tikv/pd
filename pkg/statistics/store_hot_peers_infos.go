...
func GetHotStatus(stores []*core.StoreInfo, storesLoads map[uint64]StoreLoads, regionStats map[uint64][]*HotPeerStat, typ utils.RWType, isTraceRegionFlow bool) *StoreHotPeersInfos {
...
func SummaryStoresLoad(
	...
	storesLoads map[uint64]StoreLoads,
