...
type storeCollector interface {
	...
	getLoads(storeLoads StoreLoads, peerLoadSum Loads, rwTy utils.RWType, kind constant.ResourceKind) (loads Loads)
}
...
func (tikvCollector) getLoads(storeLoads StoreLoads, peerLoadSum Loads, rwTy utils.RWType, kind constant.ResourceKind) (loads Loads) {
	switch rwTy {
	case utils.Read:
...
func (c tiflashCollector) getLoads(storeLoads StoreLoads, peerLoadSum Loads, rwTy utils.RWType, kind constant.ResourceKind) (loads Loads) {
	switch rwTy {
	case utils.Read:
