...
// AddLightLeaderRegion adds region with specified leader and followers.
func (mc *Cluster) AddLightLeaderRegion(regionID uint64, leaderStoreID uint64, otherPeerStoreIDs ...uint64) *core.RegionInfo {
