...
var (
	...
	cmdDurationListKeySpaces             = cmdDuration.WithLabelValues("list_key_spaces")
	cmdDurationGetMinServiceSafePoint    = cmdDuration.WithLabelValues("get_min_service_safe_point")
	cmdDurationUpdateKeySpaceGCSafePoint = cmdDuration.WithLabelValues("update_key_space_gc_safe_point")
	...
	cmdFailedDurationListKeySpaces             = cmdFailedDuration.WithLabelValues("list_key_spaces")
	cmdFailedDurationGetMinServiceSafePoint    = cmdFailedDuration.WithLabelValues("get_min_service_safe_point")
	cmdFailedDurationUpdateKeySpaceGCSafePoint = cmdFailedDuration.WithLabelValues("update_key_space_gc_safe_point")
