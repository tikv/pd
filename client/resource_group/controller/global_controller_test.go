...
func TestCleanupResourceGroupMetrics(t *testing.T) {
	...
	metrics.TokenConsumedByTypeCounter.WithLabelValues("cleanup-group", "rru", chargeDirection).Add(1)
	metrics.TokenConsumedByTypeCounter.WithLabelValues("cleanup-group", "rru", refundDirection).Add(1)
	metrics.TokenConsumedByTypeCounter.WithLabelValues("cleanup-group", "wru", chargeDirection).Add(1)
	metrics.TokenConsumedByTypeCounter.WithLabelValues("cleanup-group", "wru", refundDirection).Add(1)
	...
	metrics.ActualGrantTokensCounter.WithLabelValues("cleanup-group").Add(1)
	metrics.ThrottledGauge.WithLabelValues("cleanup-group").Set(1)
	metrics.ReadByteCost.WithLabelValues("cleanup-group").Add(1)
	metrics.WriteByteCost.WithLabelValues("cleanup-group", chargeDirection).Add(1)
	metrics.WriteByteCost.WithLabelValues("cleanup-group", refundDirection).Add(1)
	...
	re.False(metrics.TokenConsumedByTypeCounter.DeleteLabelValues("cleanup-group", "rru", chargeDirection))
	re.False(metrics.TokenConsumedByTypeCounter.DeleteLabelValues("cleanup-group", "rru", refundDirection))
	re.False(metrics.TokenConsumedByTypeCounter.DeleteLabelValues("cleanup-group", "wru", chargeDirection))
	re.False(metrics.TokenConsumedByTypeCounter.DeleteLabelValues("cleanup-group", "wru", refundDirection))
	...
	re.False(metrics.ActualGrantTokensCounter.DeleteLabelValues("cleanup-group"))
	...
	re.False(metrics.WriteByteCost.DeleteLabelValues("cleanup-group", chargeDirection))
	re.False(metrics.WriteByteCost.DeleteLabelValues("cleanup-group", refundDirection))
