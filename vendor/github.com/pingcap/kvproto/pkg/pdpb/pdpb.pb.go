...
// TODO: remove this once all proto is upgraded to proto3.
type MergeDirection int32

const (
	MergeDirection_Up   MergeDirection = 0
	MergeDirection_Down MergeDirection = 1
)
...
func (MergeDirection) EnumDescriptor() ([]byte, []int) { return fileDescriptorPdpb, []int{2} }
...
type Merge struct {
	Direction MergeDirection `protobuf:"varint,1,opt,name=direction,proto3,enum=pdpb.MergeDirection" json:"direction,omitempty"`
}
...
func (m *Merge) GetDirection() MergeDirection {
	if m != nil {
		return m.Direction
	}
	return MergeDirection_Up
}
...
func init() {
	...
	proto.RegisterEnum("pdpb.MergeDirection", MergeDirection_name, MergeDirection_value)
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Direction |= (MergeDirection(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorPdpb = []byte{
	...
	,
	...
	,
}
