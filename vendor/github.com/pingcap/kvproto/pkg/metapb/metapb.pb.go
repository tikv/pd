...
type Region struct {
	...
	LastSplitTimestamp uint64       `protobuf:"varint,6,opt,name=last_split_timestamp,json=lastSplitTimestamp,proto3" json:"last_split_timestamp,omitempty"`
}
...
func (m *Region) GetLastSplitTimestamp() uint64 {
	if m != nil {
	...
	for iNdEx < l {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LastSplitTimestamp |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorMetapb = []byte{
	...
	,
}
