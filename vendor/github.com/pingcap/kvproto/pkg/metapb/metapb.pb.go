...
type Region struct {
	...
	LastSplitTimestamp int64        `protobuf:"varint,6,opt,name=last_split_timestamp,json=lastSplitTimestamp,proto3" json:"last_split_timestamp,omitempty"`
}
...
func (m *Region) GetLastSplitTimestamp() int64 {
	if m != nil {
		return m.LastSplitTimestamp
	}
	return 0
}
...
func (m *Region) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.LastSplitTimestamp != 0 {
		dAtA[i] = 0x30
		i++
		i = encodeVarintMetapb(dAtA, i, uint64(m.LastSplitTimestamp))
	}
	return i, nil
}
...
func (m *Region) Size() (n int) {
	...
	if m.LastSplitTimestamp != 0 {
		n += 1 + sovMetapb(uint64(m.LastSplitTimestamp))
	}
	return n
}
...
func (m *Region) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastSplitTimestamp", wireType)
			}
			m.LastSplitTimestamp = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowMetapb
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LastSplitTimestamp |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorMetapb = []byte{
	...
	,
}
