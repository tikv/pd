...
func init() {
	...
	schedule.RegisterScheduler(ShuffleRegionType, func(opController *schedule.OperatorController, storage core.ConfigStorage, decoder schedule.ConfigDecoder) (schedule.Scheduler, error) {
