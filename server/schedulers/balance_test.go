...
func (s *testBalanceRegionSchedulerSuite) TestBalance(c *C) {
	...
	testutil.CheckTransferPeerWithLeaderTransfer(c, sb.Schedule(tc, schedule.NewOpInfluence(nil, tc))[0], schedule.OpBalance, 4, 1)
	...
	testutil.CheckTransferPeerWithLeaderTransfer(c, sb.Schedule(tc, schedule.NewOpInfluence(nil, tc))[0], schedule.OpBalance, 4, 2)
