...
func init() {
	...
	schedule.RegisterScheduler(GrantHotRegionType, func(opController *schedule.OperatorController, storage base.ConfigStorage, decoder schedule.ConfigDecoder) (schedule.Scheduler, error) {
