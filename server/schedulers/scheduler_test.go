...
func (s *testSpecialUseSuite) TestSpecialUseHotRegion(c *C) {
	...
	tc.AddLeaderRegionWithWriteInfo(4, 2, 512*KB*statistics.RegionHeartBeatReportInterval, statistics.RegionHeartBeatReportInterval, 1, 3)
	tc.AddLeaderRegionWithWriteInfo(5, 3, 512*KB*statistics.RegionHeartBeatReportInterval, statistics.RegionHeartBeatReportInterval, 1, 2)
	ops = hs.Schedule(tc)
	c.Assert(ops, HasLen, 1)
