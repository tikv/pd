...
func init() {
	...
	schedule.RegisterScheduler(BalanceRegionType, func(opController *schedule.OperatorController, storage core.ConfigStorage, decoder schedule.ConfigDecoder) (schedule.Scheduler, error) {
