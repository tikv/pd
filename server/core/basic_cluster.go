...
func (bc *BasicCluster) RandWitnessRegions(storeID uint64, ranges []KeyRange) []*RegionInfo {
	bc.RLock()
	defer bc.RUnlock()
	return bc.Regions.RandWitnessRegions(storeID, ranges, randomRegionMaxRetry)
}
