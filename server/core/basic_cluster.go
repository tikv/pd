...
func (bc *BasicCluster) PreCheckPutRegion(region *RegionInfo, checkType RegionCheckType) (*RegionInfo, []*RegionInfo, *regionItem, error) {
...
func (bc *BasicCluster) CheckAndPutRegion(region *RegionInfo) []*RegionInfo {
	origin, _, _, err := bc.PreCheckPutRegion(region, STRICT)
	if err != nil {
