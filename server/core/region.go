...
// GetOpsRead returns the read ops of the region.
func (r *RegionInfo) GetOpsRead() uint64 {
	return r.opsRead
}

// GetOpsWrite returns the write ops of the region.
func (r *RegionInfo) GetOpsWrite() uint64 {
	return r.opsWrite
}
