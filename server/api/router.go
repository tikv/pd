...
func createRouter(prefix string, svr *server.Server) *mux.Router {
	...
	registerFunc(apiRouter, "/schedulers/{name}/diagnose", schedulerHandler.DiagnoseScheduler, setMethods("POST"))
	registerFunc(apiRouter, "/schedulers/{name}/diagnose/{store_id}", schedulerHandler.DiagnoseSchedulerByStore, setMethods("POST"))
