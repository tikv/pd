...
func createRouter(prefix string, svr *server.Server) *mux.Router {
	...
	router.HandleFunc("/api/v1/hotspot/regions/read", hotStatusHandler.GetHotWriteRegions).Methods("GET")
	router.HandleFunc("/api/v1/hotspot/regions/write", hotStatusHandler.GetHotReadRegions).Methods("GET")
