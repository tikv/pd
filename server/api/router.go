...
func createRouter(prefix string, svr *server.Server) *mux.Router {
	...
	registerFunc(apiRouter, "/admin/cluster/markers/pitr-restore-mode", adminHandler.isPitrRestore, setMethods(http.MethodGet), setAuditBackend(localLog, prometheus))
	registerFunc(apiRouter, "/admin/cluster/markers/pitr-restore-mode", adminHandler.markPitrRestore, setMethods(http.MethodPost), setAuditBackend(localLog, prometheus))
	registerFunc(apiRouter, "/admin/cluster/markers/pitr-restore-mode", adminHandler.unmarkPitrRestore, setMethods(http.MethodDelete), setAuditBackend(localLog, prometheus))
