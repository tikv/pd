...
func createRouter(prefix string, svr *server.Server) *mux.Router {
	...
	registerFunc(clusterRouter, "/regions/check/oversize-region", regionsHandler.GetOverSizeRegions, setMethods("GET"))
	registerFunc(clusterRouter, "/regions/check/undersize-region", regionsHandler.GetUndersizeRegions, setMethods("GET"))
