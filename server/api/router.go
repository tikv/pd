...
func createRouter(prefix string, svr *server.Server) *mux.Router {
	...
	clusterRouter.HandleFunc("/api/v1/regions/check/histsize", regionsHandler.GetSizeHistogram).Methods("GET")
	clusterRouter.HandleFunc("/api/v1/regions/check/histkeys", regionsHandler.GetKeysHistogram).Methods("GET")
