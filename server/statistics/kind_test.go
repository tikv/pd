...
func TestGetLoads(t *testing.T) {
	...
	re.Equal(float64(regionA.GetReadQueryNum()), loads[RegionReadQueries])
	...
	re.Equal(float64(regionA.GetWriteQueryNum()), loads[RegionWriteQueries])
	...
	re.Equal(0.0, loads[RegionReadQueries])
	re.Equal(float64(regionA.GetBytesWritten()), loads[RegionWriteBytes])
	re.Equal(float64(regionA.GetKeysWritten()), loads[RegionWriteKeys])
	re.Equal(float64(regionA.GetWriteQueryNum()), loads[RegionWriteQueries])
}
