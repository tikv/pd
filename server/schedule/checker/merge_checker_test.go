...
func (suite *mergeCheckerTestSuite) TestBasic() {
	...
	ops, _ = suite.mc.Check(suite.regions[2])
	suite.NotNil(ops)
	ops, _ = suite.mc.Check(suite.regions[3])
	suite.NotNil(ops)
