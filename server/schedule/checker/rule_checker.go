...
func NewRuleChecker(cluster opt.Cluster, ruleManager *placement.RuleManager, regionWaitingList cache.Cache,
	regionPriorityQueue *cache.PriorityQueue) *RuleChecker {
	return &RuleChecker{
		cluster:             cluster,
