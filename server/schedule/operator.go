...
// Clone copy this operator step.
func (tl TransferLeader) Clone() OperatorStep {
	return TransferLeader{tl.FromStore, tl.ToStore}
}
...
// Clone copy this operator step.
func (ap AddPeer) Clone() OperatorStep {
	return AddPeer{ap.ToStore, ap.PeerID}
}
...
// Clone copy this operator step.
func (al AddLearner) Clone() OperatorStep {
	return AddLearner{al.ToStore, al.PeerID}
}
...
// Clone copy this operator step.
func (pl PromoteLearner) Clone() OperatorStep {
	return PromoteLearner{pl.ToStore, pl.PeerID}
}
...
// Clone copy this operator step.
func (rp RemovePeer) Clone() OperatorStep {
	return RemovePeer{rp.FromStore}
}
...
// Clone copy this operator step.
func (mr MergeRegion) Clone() OperatorStep {
	return MergeRegion{mr.FromRegion, mr.ToRegion, mr.IsPassive}
}
...
// Clone copy this operator step.
func (sr SplitRegion) Clone() OperatorStep {
	return SplitRegion{sr.StartKey, sr.EndKey}
}
