...
type CreateSchedulerFunc func(opController *OperatorController, storage base.ConfigStorage, dec ConfigDecoder) (Scheduler, error)
...
func CreateScheduler(typ string, opController *OperatorController, storage base.ConfigStorage, dec ConfigDecoder) (Scheduler, error) {
