...
// GetLeaderRegion gets region and leader peer by regionID from cluster.
func (c *RaftCluster) GetLeaderRegion(regionID uint64) (*metapb.Region, *metapb.Peer) {
	return c.cachedCluster.regions.getLeaderRegion(regionID)
}
