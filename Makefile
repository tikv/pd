...
LDFLAGS += -X "$(PD_PKG)/pkg/versioninfo.PDBuildTS=$(BUILDTS)"
...
ifneq ($(DASHBOARD), 0)
	...
	LDFLAGS += -X "github.com/pingcap/tidb-dashboard/pkg/utils/version.PDVersion=$(RELEASE_VERSION)"
	LDFLAGS += -X "github.com/pingcap/tidb-dashboard/pkg/utils/version.BuildTime=$(BUILDTS)"
