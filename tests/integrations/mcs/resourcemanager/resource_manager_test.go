...
func (tokenConsumptionPerSecond) makeReadRequest() *controller.TestRequestInfo {
	return controller.NewTestRequestInfo(false, 0, 0, false)
}

func (t tokenConsumptionPerSecond) makeWriteRequest() *controller.TestRequestInfo {
	return controller.NewTestRequestInfo(true, uint64(t.wruTokensAtATime-1), 0, false)
}
...
func (suite *resourceManagerClientTestSuite) TestResourcePenalty() {
	...
	// init
	req := controller.NewTestRequestInfo(false, 0, 2 /* store2 */, false)
	...
	req = controller.NewTestRequestInfo(true, 60, 1 /* store1 */, false)
	...
	req = controller.NewTestRequestInfo(true, 20, 1 /* store1 */, false)
	...
	req1 := controller.NewTestRequestInfo(false, 0, 1 /* store1 */, false)
	...
	req2 := controller.NewTestRequestInfo(true, 50, 2 /* store2 */, false)
	...
	req3 := controller.NewTestRequestInfo(true, 0, 3 /* store3 */, false)
	...
	req4 := controller.NewTestRequestInfo(true, 50, 1 /* store2 */, false)
