...
<<<<<<< HEAD:tests/integrations/mcs/go.mod
	github.com/pingcap/tidb-dashboard v0.0.0-20250801104359-5498b71a21cf // indirect
=======
	github.com/pingcap/tidb-dashboard v0.0.0-20250908031600-468ef95996bb // indirect
>>>>>>> e2f7162d7 (chore(dashboard): update TiDB Dashboard to 20250908031600-468ef95996bb (#9770)):tests/integrations/go.mod
