...
require (
	...
	github.com/pingcap/tidb-dashboard v0.0.0-20230626093106-fcc40851da45 // indirect
...
replace github.com/pingcap/kvproto => github.com/ystaticy/kvproto v0.0.0-20230705044915-c88b24fbdbdc
