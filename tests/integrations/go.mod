...
replace (
	github.com/pingcap/kvproto => github.com/lhy1024/kvproto v0.0.0-20260328032440-f4277e7c5624
	github.com/tikv/pd => ../../
...
require (
	...
	github.com/pingcap/tidb-dashboard v0.0.0-20251212012447-87dbabf00c47 // indirect
