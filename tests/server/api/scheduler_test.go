...
func (suite *balanceRangeSchedulerTestSuite) SetupSuite() {
	re := suite.Require()
...
func (suite *balanceRangeSchedulerTestSuite) TearDownSuite() {
	suite.cleanup()
}

func (suite *balanceRangeSchedulerTestSuite) TestSchedulerJobs() {
