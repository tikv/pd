...
Consider that raml2html depends on various npm packages and can only be run under specific version of node. It is recommended to use docker to simplify the compilation of raml. You can run it in the root directory of PD:
