    ...
    "definitions": {
        ...
        "config.Config": {
            ...
            "properties": {
                ...
                "logProps": {
                    "type": "object",
                    "$ref": "#/definitions/log.ZapProperties"
                },
                "logger": {
                    "type": "object",
                    "$ref": "#/definitions/zap.Logger"
                },
                "metric": {
                    "type": "object",
        ...
        "pflag.Flag": {
            ...
            "properties": {
                "annotations": {
                    "description": "used by cobra.Command bash autocomple code",
                    "type": "object",
                    "additionalProperties": {
                        "type": "array",
                        "items": {
                ...
                "changed": {
                    "description": "If the user set the value (or if left to default)",
                    "type": "boolean"
                },
                "defValue": {
                ...
                "deprecated": {
                    "description": "If this flag is deprecated, this string is the new or now thing to use",
                    "type": "string"
                },
                "hidden": {
                    "description": "used by cobra.Command to allow flags to be hidden from help/usage text",
                    "type": "boolean"
                },
                "name": {
                ...
                "noOptDefVal": {
                    "description": "default value (as text); if the flag is on the command line without any options",
                    "type": "string"
                },
                "shorthand": {
                    "description": "one-letter abbreviated flag",
                    "type": "string"
                },
                "shorthandDeprecated": {
                    "description": "If the shorthand of this flag is deprecated, this string is the new or now thing to use",
                    "type": "string"
                },
                "usage": {
        ...
        "pflag.FlagSet": {
            ...
            "properties": {
                ...
                "args": {
                    "description": "arguments after flags",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "argsLenAtDash": {
                    "description": "len(args) when a '--' was located when parsing, or -1 if no --",
                    "type": "integer"
                },
                "errorHandling": {
                    "type": "integer"
                ...
                "interspersed": {
                    "description": "allow interspersed option/non-option args",
                    "type": "boolean"
                },
                "name": {
                    "type": "string"
                ...
                "output": {
                    "description": "nil means stderr; use out() accessor",
                    "type": "string"
                },
        ...
        "zap.Logger": {
            ...
            "properties": {
                ...
                "addStack": {
                    "type": "object",
                    "$ref": "#/definitions/zapcore.LevelEnabler"
                },
                "callerSkip": {
                    "type": "integer"
                },
