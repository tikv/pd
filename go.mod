...
require (
	...
	github.com/pingcap-incubator/tidb-dashboard v0.0.0-20200214091120-1684efb12212
...
replace github.com/pingcap/kvproto => github.com/rleungx/kvproto v0.0.0-20200109035058-e80ec4ce10a1
